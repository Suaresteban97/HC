...
const app = Vue.createApp({
    ...
    methods: {
        ...
        getChips(){
            axios.get('http://api_hc.test/api/chips').then(response => {
                this.chips = response.data;
            }); 
        },

        getBranches(){
            axios.get('http://api_hc.test/api/ubications').then(response => {
        ...
        getLocations(){
            axios.get('http://api_hc.test/api/locations').then(response => {
        ...
        getFilteredBranches(params) {
            ...
            axios.get('http://api_hc.test/api/filteredBranches', { params }).then(response => {
